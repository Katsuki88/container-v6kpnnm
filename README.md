...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-v6kpnnm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-v6kpnnm.containers.anotherwebservice.com/
...
```
git clone git@github.com:Katsuki88/container-v6kpnnm.git
cd container-v6kpnnm
```
...
```
docker attach container-v6kpnnm
```
